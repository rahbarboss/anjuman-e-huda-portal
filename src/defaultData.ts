...
export const initialDatabase: AppDatabase = {
  homepage: {
    ...
    heroBadge: "ESTD. 1994 • STUDENTS' UNION",
    heroBgUrl:
  ...
  contactSettings: {
    campusAddress: "Central Union Administrative Complex, Student Activity Quadrangle, University Main Campus, Gate No. 4, Pin 247554",
